...
@implementation  XDGPUImageGaussianSelectiveBlurFilter
...
- (id)init;
{
    ...
    selectiveFocusFilter = [[XDGPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageGaussianSelectiveBlurFragmentShaderString];
