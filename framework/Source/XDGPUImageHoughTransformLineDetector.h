...
@interface  XDGPUImageHoughTransformLineDetector :  XDGPUImageFilterGroup
{
     XDGPUImageOutput<XDGPUImageInput> *thresholdEdgeDetectionFilter;
    
//     XDGPUImageThresholdEdgeDetectionFilter *thresholdEdgeDetectionFilter;
     XDGPUImageParallelCoordinateLineTransformFilter *parallelCoordinateLineTransformFilter;
