...
@interface  XDGPUImageSoftEleganceFilter :  XDGPUImageFilterGroup
{
     XDGPUImagePicture *lookupImageSource1;
     XDGPUImagePicture *lookupImageSource2;
}
