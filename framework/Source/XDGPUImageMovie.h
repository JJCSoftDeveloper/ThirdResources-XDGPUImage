 ...
 */
@protocol  XDGPUImageMovieDelegate <NSObject>
 ...
 */
@interface  XDGPUImageMovie :  XDGPUImageOutput
 ...
 */
@property (readwrite, nonatomic, assign) id <XDGPUImageMovieDelegate>delegate;
