...
@class  XDGPUImage3x3TextureSamplingFilter;
@class  XDGPUImageNonMaximumSuppressionFilter;
...
typedef enum { kGPUImageFAST12Contiguous, kGPUImageFAST12ContiguousNonMaximumSuppressed}  XDGPUImageFASTDetectorType;

@interface  XDGPUImageFASTCornerDetectionFilter :  XDGPUImageFilterGroup
{
     XDGPUImageGrayscaleFilter *luminanceReductionFilter;
     XDGPUImage3x3TextureSamplingFilter *featureDetectionFilter;
     XDGPUImageNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
...
- (id)initWithFASTDetectorVariant:(XDGPUImageFASTDetectorType)detectorType;
