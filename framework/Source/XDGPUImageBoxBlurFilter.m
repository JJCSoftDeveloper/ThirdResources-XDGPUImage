...
@implementation  XDGPUImageBoxBlurFilter
...
- (id)init;
{
    //    NSString *currentGaussianBlurVertexShader = [XDGPUImageGaussianBlurFilter vertexShaderForStandardGaussianOfRadius:4 sigma:2.0];
    //    NSString *currentGaussianBlurFragmentShader = [XDGPUImageGaussianBlurFilter fragmentShaderForStandardGaussianOfRadius:4 sigma:2.0];
