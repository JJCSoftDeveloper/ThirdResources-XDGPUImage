...
@interface  XDGPUImageAdaptiveThresholdFilter()
{
     XDGPUImageBoxBlurFilter *boxBlurFilter;
}
@end

@implementation  XDGPUImageAdaptiveThresholdFilter
...
- (id)init;
{
    ...
    // First pass: reduce to luminance
     XDGPUImageGrayscaleFilter *luminanceFilter = [[XDGPUImageGrayscaleFilter alloc] init];
    [self addFilter:luminanceFilter];
    
    // Second pass: perform a box blur
    boxBlurFilter = [[XDGPUImageBoxBlurFilter alloc] init];
    [self addFilter:boxBlurFilter];
    
    // Third pass: compare the blurred background luminance to the local value
     XDGPUImageFilter *adaptiveThresholdFilter = [[XDGPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageAdaptiveThresholdFragmentShaderString];
