...
@class  XDGPUImageSaturationFilter;
@class  XDGPUImageGaussianBlurFilter;
@class  XDGPUImageLuminanceRangeFilter;

@interface  XDGPUImageiOSBlurFilter :  XDGPUImageFilterGroup
{
     XDGPUImageSaturationFilter *saturationFilter;
     XDGPUImageGaussianBlurFilter *blurFilter;
     XDGPUImageLuminanceRangeFilter *luminanceRangeFilter;
}
