...
@class  XDGPUImageToonFilter;

/** This uses a similar process as the  XDGPUImageToonFilter, only it precedes the toon effect with a Gaussian blur to smooth out noise.
 */
@interface  XDGPUImageSmoothToonFilter :  XDGPUImageFilterGroup
{
     XDGPUImageGaussianBlurFilter *blurFilter;
     XDGPUImageToonFilter *toonFilter;
}
