...
#define  XDGPUImageHashIdentifier #
#define  XDGPUImageWrappedLabel(x) x
#define  XDGPUImageEscapedHashIdentifier(a)  XDGPUImageWrappedLabel(XDGPUImageHashIdentifier)a
...
/**  XDGPUImage's base filter class
 
 Filters and other subsequent elements in the chain conform to the  XDGPUImageInput protocol, which lets them take in the supplied or processed texture from the previous link in the chain and do something with it. Objects one step further down the chain are considered targets, and processing can be branched by adding multiple targets to a single output or filter.
 */
@interface  XDGPUImageFilter :  XDGPUImageOutput <XDGPUImageInput>
{
    ...
    CGSize currentFilterSize;
     XDGPUImageRotationMode inputRotation;
...
- (CGPoint)rotatedPoint:(CGPoint)pointToRotate forRotation:(XDGPUImageRotationMode)rotation;
