...
@protocol XDGPUImageVideoCameraDelegate <NSObject>
...
/**
 A XDGPUImageOutput that provides frames from either camera
*/
@interface XDGPUImageVideoCamera : XDGPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
...
//	AVCaptureVideoDataOutput *videoOutput;
    ...
    BOOL capturePaused;
    XDGPUImageRotationMode outputRotation, internalRotation;
    dispatch_semaphore_t frameRenderingSemaphore;
        
    BOOL captureAsYUV;
    GLuint luminanceTexture, chrominanceTexture;

    __unsafe_unretained id<XDGPUImageVideoCameraDelegate> _delegate;
}
...
@property(nonatomic, assign) id<XDGPUImageVideoCameraDelegate> delegate;
