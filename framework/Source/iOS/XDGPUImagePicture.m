...
@implementation  XDGPUImagePicture
...
- (id)initWithCGImage:(CGImageRef)newImageSource smoothlyScaleOutput:(BOOL)smoothlyScaleOutput;
{
    ...
    CGSize scaledImageSizeToFitOnGPU = [XDGPUImageContext sizeThatFitsWithinATextureForSize:pixelSizeOfImage];
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        outputFramebuffer = [[XDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:pixelSizeToUseForTexture onlyTexture:YES];
...
- (void)processImageUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage))block;
{
