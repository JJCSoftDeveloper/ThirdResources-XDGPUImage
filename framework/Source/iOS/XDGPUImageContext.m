...
@implementation  XDGPUImageContext
...
+ (XDGPUImageContext *)sharedImageProcessingContext;
{
    static dispatch_once_t pred;
    static  XDGPUImageContext *sharedImageProcessingContext = nil;
...
+ (XDGPUImageFramebufferCache *)sharedFramebufferCache;
{
...
{
    [[XDGPUImageContext sharedImageProcessingContext] useAsCurrentContext];
}
...
{
     XDGPUImageContext *sharedContext = [XDGPUImageContext sharedImageProcessingContext];
...
+ (BOOL)deviceSupportsRedTextures;
{
    ...
    dispatch_once(&pred, ^{
        supportsRedTextures = [XDGPUImageContext deviceSupportsOpenGLESExtension:@"GL_EXT_texture_rg"];
    });
...
+ (BOOL)deviceSupportsFramebufferReads;
{
    ...
    dispatch_once(&pred, ^{
        supportsFramebufferReads = [XDGPUImageContext deviceSupportsOpenGLESExtension:@"GL_EXT_shader_framebuffer_fetch"];
    });
...
- (EAGLContext *)createContext;
{
    ...
    NSAssert(context != nil, @"Unable to create an OpenGL ES 2.0 context. The  XDGPUImage framework requires OpenGL ES 2.0 support to work.");
    return context;
}
...
- (XDGPUImageFramebufferCache *)framebufferCache;
{
    if (_framebufferCache == nil)
    {
        _framebufferCache = [[XDGPUImageFramebufferCache alloc] init];
    }
