...
@interface  XDGPUImageMovieWriter ()
{
...
- (void)renderAtInternalSizeUsingFramebuffer:(XDGPUImageFramebuffer *)inputFramebufferToUse;

@end

@implementation  XDGPUImageMovieWriter
...
- (id)initWithMovieURL:(NSURL *)newMovieURL size:(CGSize)newSize fileType:(NSString *)newFileType outputSettings:(NSMutableDictionary *)outputSettings;
{
    ...
    _movieWriterContext = [[XDGPUImageContext alloc] init];
    [_movieWriterContext useSharegroup:[[[XDGPUImageContext sharedImageProcessingContext] context] sharegroup]];
...
- (void)renderAtInternalSizeUsingFramebuffer:(XDGPUImageFramebuffer *)inputFramebufferToUse;
{
    ...
    const GLfloat *textureCoordinates = [XDGPUImageFilter textureCoordinatesForRotation:inputRotation];
...
- (void)newFrameReadyAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex;
{
    ...
    if (CMTIME_IS_INVALID(startTime))
    {
     ...
     XDGPUImageFramebuffer *inputFramebufferForBlock = firstInputFramebuffer;
    glFinish();
