...
@protocol  XDGPUImageMovieWriterDelegate <NSObject>
...
@interface  XDGPUImageMovieWriter : NSObject <XDGPUImageInput>
{
    ...
    AVAssetWriterInputPixelBufferAdaptor *assetWriterPixelBufferInput;
     ...
     XDGPUImageContext *_movieWriterContext;
...
@property(nonatomic, assign) id<XDGPUImageMovieWriterDelegate> delegate;
...
@property(nonatomic, retain)  XDGPUImageContext *movieWriterContext;
