...
} XDGPUImageFillModeType; 

/**
 UIView subclass to use as an endpoint for displaying XDGPUImage outputs
 */
@interface XDGPUImageView : UIView <XDGPUImageInput>
{
 ...
 */
@property(readwrite, nonatomic) XDGPUImageFillModeType fillMode;
