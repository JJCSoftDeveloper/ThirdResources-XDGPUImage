...
@interface  XDGPUImageMotionDetector :  XDGPUImageFilterGroup
{
     XDGPUImageLowPassFilter *lowPassFilter;
     XDGPUImageTwoInputFilter *frameComparisonFilter;
     XDGPUImageAverageColor *averageColor;
}
