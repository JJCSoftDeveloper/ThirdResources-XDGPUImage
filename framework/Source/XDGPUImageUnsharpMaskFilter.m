...
@implementation  XDGPUImageUnsharpMaskFilter
...
- (id)init;
{
    ...
    unsharpMaskFilter = [[XDGPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageUnsharpMaskFragmentShaderString];
