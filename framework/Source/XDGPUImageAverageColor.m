...
@implementation  XDGPUImageAverageColor
...
- (id)init;
{
    ...
    __unsafe_unretained  XDGPUImageAverageColor *weakSelf = self;
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    for (NSUInteger currentReduction = 0; currentReduction < reductionsToHitSideLimit; currentReduction++)
    {
        ...
        outputFramebuffer = [[XDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:currentStageSize textureOptions:self.outputTextureOptions onlyTexture:NO];
