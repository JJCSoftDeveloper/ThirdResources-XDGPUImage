...
@class  XDGPUImageGaussianBlurFilter;
@class  XDGPUImageXYDerivativeFilter;
@class  XDGPUImageGrayscaleFilter;
@class  XDGPUImageGaussianBlurFilter;
@class  XDGPUImageThresholdedNonMaximumSuppressionFilter;
@class  XDGPUImageColorPackingFilter;

//#define DEBUGFEATUREDETECTION

/** Harris corner detector
 
 First pass: reduce to luminance and take the derivative of the luminance texture (XDGPUImageXYDerivativeFilter)
 
 Second pass: blur the derivative (XDGPUImageGaussianBlurFilter)
 ...
 */
@interface  XDGPUImageHarrisCornerDetectionFilter :  XDGPUImageFilterGroup
{
     XDGPUImageXYDerivativeFilter *derivativeFilter;
     XDGPUImageGaussianBlurFilter *blurFilter;
     XDGPUImageFilter *harrisCornerDetectionFilter;
     XDGPUImageThresholdedNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
     XDGPUImageColorPackingFilter *colorPackingFilter;
