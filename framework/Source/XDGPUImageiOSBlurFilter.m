...
@implementation  XDGPUImageiOSBlurFilter
...
- (id)init;
{
    ...
    saturationFilter = [[XDGPUImageSaturationFilter alloc] init];
    ...
    luminanceRangeFilter = [[XDGPUImageLuminanceRangeFilter alloc] init];
