...
@implementation  XDGPUImageSobelEdgeDetectionFilter
...
- (void)setupFilterForSize:(CGSize)filterFrameSize;
{
    if (!hasOverriddenImageSizeFactor)
    {
        ...
        runSynchronouslyOnVideoProcessingQueue(^{
            GLProgram *previousProgram = [XDGPUImageContext sharedImageProcessingContext].currentShaderProgram;
            ...
            [XDGPUImageContext setActiveShaderProgram:previousProgram];
        });
    }
}
