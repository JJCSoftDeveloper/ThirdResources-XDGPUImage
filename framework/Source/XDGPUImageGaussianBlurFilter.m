...
@implementation  XDGPUImageGaussianBlurFilter
...
//    NSLog(@"Max varyings: %d", [XDGPUImageContext maximumVaryingVectorsForThisDevice]);
...
- (void)switchToVertexShader:(NSString *)newVertexShader fragmentShader:(NSString *)newFragmentShader;
{
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        filterProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:newVertexShader fragmentShaderString:newFragmentShader];
        ...
        secondFilterProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:newVertexShader fragmentShaderString:newFragmentShader];
