...
@implementation  XDGPUImageLuminosity
...
- (id)init;
{
    ...
    __unsafe_unretained  XDGPUImageLuminosity *weakSelf = self;
    [self setFrameProcessingCompletionBlock:^(XDGPUImageOutput *filter, CMTime frameTime) {
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        secondFilterProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:kGPUImageColorAveragingVertexShaderString fragmentShaderString:kGPUImageLuminosityFragmentShaderString];
