...
@interface  XDGPUImageRawDataInput()
- (void)uploadBytes:(GLubyte *)bytesToUpload;
@end

@implementation  XDGPUImageRawDataInput
...
- (void)uploadBytes:(GLubyte *)bytesToUpload;
{
    ...
    outputFramebuffer = [[XDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:uploadedImageSize textureOptions:self.outputTextureOptions onlyTexture:YES];
