...
@implementation  XDGPUImageUIElement
...
//    CGContextRotateCTM(imageContext, M_PI_2);
    ...
    outputFramebuffer = [[XDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:layerPixelSize textureOptions:self.outputTextureOptions onlyTexture:YES];
