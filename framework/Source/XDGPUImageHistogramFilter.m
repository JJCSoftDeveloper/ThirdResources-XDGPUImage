...
@implementation  XDGPUImageHistogramFilter
    ...
    switch (newHistogramType)
    {
        ...
        case kGPUImageHistogramRGB:
        {
            ...
            runSynchronouslyOnVideoProcessingQueue(^{
                ...
                secondFilterProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:kGPUImageGreenHistogramSamplingVertexShaderString fragmentShaderString:kGPUImageHistogramAccumulationFragmentShaderString];
                thirdFilterProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:kGPUImageBlueHistogramSamplingVertexShaderString fragmentShaderString:kGPUImageHistogramAccumulationFragmentShaderString];
                ...
                if (!secondFilterProgram.initialized)
                {
                    ...
                    [XDGPUImageContext setActiveShaderProgram:secondFilterProgram];
                ...
                [XDGPUImageContext setActiveShaderProgram:thirdFilterProgram];
...
- (void)dealloc;
{
    if (vertexSamplingCoordinates != NULL && ![XDGPUImageContext supportsFastTextureUpload])
    {
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    outputFramebuffer = [[XDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:[self sizeOfFBO] textureOptions:self.outputTextureOptions onlyTexture:NO];
    ...
    [XDGPUImageContext setActiveShaderProgram:filterProgram];
