...
@implementation  XDGPUImageMotionDetector
...
- (id)init;
{
    ...
    lowPassFilter = [[XDGPUImageLowPassFilter alloc] init];
    ...
    frameComparisonFilter = [[XDGPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageMotionComparisonFragmentShaderString];
    ...
    averageColor = [[XDGPUImageAverageColor alloc] init];
    
    __unsafe_unretained  XDGPUImageMotionDetector *weakSelf = self;
