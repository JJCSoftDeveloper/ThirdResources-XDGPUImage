...
@implementation  XDGPUImageFilter
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        filterProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:vertexShaderString fragmentShaderString:fragmentShaderString];
...
- (CGImageRef)newCGImageFromCurrentlyProcessedOutput
{
    ...
    if (dispatch_semaphore_wait(imageCaptureSemaphore, convertedTimeout) != 0)
    {
     ...
     XDGPUImageFramebuffer* framebuffer = [self framebufferForOutput];
...
- (void)setMatrix3f:(GPUMatrix3x3)matrix forUniform:(GLint)uniform program:(GLProgram *)shaderProgram;
{
    runAsynchronouslyOnVideoProcessingQueue(^{
        [XDGPUImageContext setActiveShaderProgram:shaderProgram];
