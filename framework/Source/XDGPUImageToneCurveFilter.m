...
#pragma mark -
#pragma mark  XDGPUImageACVFile Helper
...
@interface  XDGPUImageACVFile : NSObject{
    short version;
    short totalCurves;
...
@implementation  XDGPUImageACVFile
...
#pragma mark -
#pragma mark  XDGPUImageToneCurveFilter Implementation
...
@interface  XDGPUImageToneCurveFilter()
{
...
@implementation  XDGPUImageToneCurveFilter
...
- (id)initWithACVData:(NSData *)data {
    ...
    toneCurveTextureUniform = [filterProgram uniformIndex:@"toneCurveTexture"];
     ...
     XDGPUImageACVFile *curve = [[XDGPUImageACVFile alloc] initWithACVFileData:data];
...
{
    NSData* fileData = [NSData dataWithContentsOfURL:curveFileURL];
     XDGPUImageACVFile *curve = [[XDGPUImageACVFile alloc] initWithACVFileData:fileData];
