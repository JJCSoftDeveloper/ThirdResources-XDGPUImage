...
void XDGPUImageCreateResizedSampleBuffer(CVPixelBufferRef cameraFrame, CGSize finalSize, CMSampleBufferRef *sampleBuffer)
{
...
@interface XDGPUImageStillCamera ()
{
...
- (void)capturePhotoProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withImageOnGPUHandler:(void (^)(NSError *error))block;

@end

@implementation XDGPUImageStillCamera {
...
- (void)capturePhotoAsImageProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage, NSError *error))block;
{
...
- (void)capturePhotoAsImageProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withOrientation:(UIImageOrientation)orientation withCompletionHandler:(void (^)(UIImage *processedImage, NSError *error))block {
    [self capturePhotoProcessedUpToFilter:finalFilterInChain withImageOnGPUHandler:^(NSError *error) {
        UIImage *filteredPhoto = nil;
...
- (void)capturePhotoAsJPEGProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(NSData *processedJPEG, NSError *error))block;
{
//    reportAvailableMemoryForXDGPUImage(@"Before Capture");
    ...
    [self capturePhotoProcessedUpToFilter:finalFilterInChain withImageOnGPUHandler:^(NSError *error) {
        ...
        if(!error){
            @autoreleasepool {
                ...
                dispatch_semaphore_signal(frameRenderingSemaphore);
//                reportAvailableMemoryForXDGPUImage(@"After UIImage generation");

                dataForJPEGFile = UIImageJPEGRepresentation(filteredPhoto,self.jpegCompressionQuality);
//                reportAvailableMemoryForXDGPUImage(@"After JPEG generation");
            }

//            reportAvailableMemoryForXDGPUImage(@"After autorelease pool");
        }else{
            dispatch_semaphore_signal(frameRenderingSemaphore);
        }
...
- (void)capturePhotoAsJPEGProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withOrientation:(UIImageOrientation)orientation withCompletionHandler:(void (^)(NSData *processedImage, NSError *error))block {
    [self capturePhotoProcessedUpToFilter:finalFilterInChain withImageOnGPUHandler:^(NSError *error) {
        NSData *dataForJPEGFile = nil;
...
- (void)capturePhotoAsPNGProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(NSData *processedPNG, NSError *error))block;
{
...
- (void)capturePhotoAsPNGProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withOrientation:(UIImageOrientation)orientation withCompletionHandler:(void (^)(NSData *processedPNG, NSError *error))block;
{
...
- (void)capturePhotoProcessedUpToFilter:(XDGPUImageOutput<XDGPUImageInput> *)finalFilterInChain withImageOnGPUHandler:(void (^)(NSError *error))block
{
    ...
    [photoOutput captureStillImageAsynchronouslyFromConnection:[[photoOutput connections] objectAtIndex:0] completionHandler:^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
        ...
        CGSize scaledImageSizeToFitOnGPU = [XDGPUImageContext sizeThatFitsWithinATextureForSize:sizeOfPhoto];
        if (!CGSizeEqualToSize(sizeOfPhoto, scaledImageSizeToFitOnGPU))
        {
            ...
            {
                XDGPUImageCreateResizedSampleBuffer(cameraFrame, scaledImageSizeToFitOnGPU, &sampleBuffer);
            }
...
//            if ( (currentCameraPosition != AVCaptureDevicePositionFront) || (![XDGPUImageContext supportsFastTextureUpload]) || !requiresFrontCameraTextureCacheCorruptionWorkaround)
//            {
//                dispatch_semaphore_signal(frameRenderingSemaphore);
//                [finalFilterInChain useNextFrameForImageCapture];
