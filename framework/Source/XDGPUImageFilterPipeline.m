...
@interface  XDGPUImageFilterPipeline ()
...
@implementation  XDGPUImageFilterPipeline
...
- (BOOL)_parseConfiguration:(NSDictionary *)configuration {
    ...
    for (NSDictionary *filter in filters) {
        ...
        Class theClass = NSClassFromString(filterName);
         XDGPUImageOutput<XDGPUImageInput> *genericFilter = [[theClass alloc] init];
...
- (void)_refreshFilters {
    ...
    id prevFilter = self.input;
     XDGPUImageOutput<XDGPUImageInput> *theFilter = nil;
...
- (UIImage *)currentFilteredFrame {
    return [(XDGPUImageOutput<XDGPUImageInput> *)[_filters lastObject] imageFromCurrentFramebuffer];
}

- (UIImage *)currentFilteredFrameWithOrientation:(UIImageOrientation)imageOrientation {
  return [(XDGPUImageOutput<XDGPUImageInput> *)[_filters lastObject] imageFromCurrentFramebufferWithOrientation:imageOrientation];
}

- (CGImageRef)newCGImageFromCurrentFilteredFrame {
    return [(XDGPUImageOutput<XDGPUImageInput> *)[_filters lastObject] newCGImageFromCurrentlyProcessedOutput];
}
