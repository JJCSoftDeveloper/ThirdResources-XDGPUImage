...
@class  XDGPUImageSingleComponentGaussianBlurFilter;
@class  XDGPUImageDirectionalSobelEdgeDetectionFilter;
@class  XDGPUImageDirectionalNonMaximumSuppressionFilter;
@class  XDGPUImageWeakPixelInclusionFilter;
 ...
 */
@interface  XDGPUImageCannyEdgeDetectionFilter :  XDGPUImageFilterGroup
{
     XDGPUImageGrayscaleFilter *luminanceFilter;
     XDGPUImageSingleComponentGaussianBlurFilter *blurFilter;
     XDGPUImageDirectionalSobelEdgeDetectionFilter *edgeDetectionFilter;
     XDGPUImageDirectionalNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
     XDGPUImageWeakPixelInclusionFilter *weakPixelInclusionFilter;
}
