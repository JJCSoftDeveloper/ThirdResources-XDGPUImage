...
@interface  XDGPUImageLookupFilter :  XDGPUImageTwoInputFilter
{
    GLint intensityUniform;
}

// How To Use:
// 1) Use your favourite photo editing application to apply a filter to lookup.png from  XDGPUImage/framework/Resources.
...
// E.g. color_balance_lookup_1.png ->  XDGPUImageGaussianBlurFilter -> color_balance_lookup_2.png
// 2) Use you new lookup.png file as a second input for  XDGPUImageLookupFilter.

// See  XDGPUImageAmatorkaFilter,  XDGPUImageMissEtikateFilter, and  XDGPUImageSoftEleganceFilter for example.
