...
@interface  XDGPUImageHoughTransformLineDetector()

- (void)extractLineParametersFromImageAtFrameTime:(CMTime)frameTime;

@end

@implementation  XDGPUImageHoughTransformLineDetector
...
//    if ([XDGPUImageContext deviceSupportsFramebufferReads])
//    if ([XDGPUImageContext deviceSupportsFramebufferReads])
//    {
//        thresholdEdgeDetectionFilter = [[XDGPUImageThresholdEdgeDetectionFilter alloc] init];
//        thresholdEdgeDetectionFilter = [[XDGPUImageSobelEdgeDetectionFilter alloc] init];
//        [(XDGPUImageThresholdEdgeDetectionFilter *)thresholdEdgeDetectionFilter setThreshold:0.07];
//        [(XDGPUImageThresholdEdgeDetectionFilter *)thresholdEdgeDetectionFilter setEdgeStrength:0.25];
//        [(XDGPUImageThresholdEdgeDetectionFilter *)thresholdEdgeDetectionFilter setEdgeStrength:1.0];
//        thresholdEdgeDetectionFilter = [[XDGPUImageCannyEdgeDetectionFilter alloc] init];
//    }
//    else
//    {
        thresholdEdgeDetectionFilter = [[XDGPUImageCannyEdgeDetectionFilter alloc] init];
//    }
    ...
    parallelCoordinateLineTransformFilter = [[XDGPUImageParallelCoordinateLineTransformFilter alloc] init];
    [self addFilter:parallelCoordinateLineTransformFilter];
    
    // Third pass: apply non-maximum suppression
    if ([XDGPUImageContext deviceSupportsFramebufferReads])
    {
        nonMaximumSuppressionFilter = [[XDGPUImageThresholdedNonMaximumSuppressionFilter alloc] initWithPackedColorspace:YES];
    }
    else
    {
        nonMaximumSuppressionFilter = [[XDGPUImageThresholdedNonMaximumSuppressionFilter alloc] initWithPackedColorspace:NO];
    }
    [self addFilter:nonMaximumSuppressionFilter];
    
    __unsafe_unretained  XDGPUImageHoughTransformLineDetector *weakSelf = self;
...
//    __unsafe_unretained  XDGPUImageOutput<XDGPUImageInput> *weakEdgeDetectionFilter = thresholdEdgeDetectionFilter;
//    [thresholdEdgeDetectionFilter setFrameProcessingCompletionBlock:^(XDGPUImageOutput *filter, CMTime frameTime){
...
//    }];
//
//    __unsafe_unretained  XDGPUImageOutput<XDGPUImageInput> *weakParallelCoordinateLineTransformFilter = parallelCoordinateLineTransformFilter;
//    [parallelCoordinateLineTransformFilter setFrameProcessingCompletionBlock:^(XDGPUImageOutput *filter, CMTime frameTime){
//        UIImage *intermediateImage = [weakParallelCoordinateLineTransformFilter imageFromCurrentFramebuffer];
//        [weakIntermediateImages addObject:intermediateImage];
//    }];

    __unsafe_unretained  XDGPUImageOutput<XDGPUImageInput> *weakNonMaximumSuppressionFilter = nonMaximumSuppressionFilter;
    [nonMaximumSuppressionFilter setFrameProcessingCompletionBlock:^(XDGPUImageOutput *filter, CMTime frameTime){
...
//{
//    [(XDGPUImageCannyEdgeDetectionFilter *)thresholdEdgeDetectionFilter setThreshold:newValue];
//}
//
//- (CGFloat)edgeThreshold;
//{
//    return [(XDGPUImageCannyEdgeDetectionFilter *)thresholdEdgeDetectionFilter threshold];
//}
