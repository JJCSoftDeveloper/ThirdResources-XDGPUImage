...
@interface  XDGPUImageRawDataOutput ()
{
     XDGPUImageFramebuffer *firstInputFramebuffer, *outputFramebuffer, *retainedFramebuffer;
...
@implementation  XDGPUImageRawDataOutput
...
- (id)initWithImageSize:(CGSize)newImageSize resultsInBGRAFormat:(BOOL)resultsInBGRAFormat;
{
    ...
    if ( (outputBGRA && ![XDGPUImageContext supportsFastTextureUpload]) || (!outputBGRA && [XDGPUImageContext supportsFastTextureUpload]) )
    {
        dataProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:kGPUImageColorSwizzlingFragmentShaderString];
    }
    else
    {
        dataProgram = [[XDGPUImageContext sharedImageProcessingContext] programForVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:kGPUImagePassthroughFragmentShaderString];
    }
...
- (void)dealloc
{
    if (_rawBytesForImage != NULL && (![XDGPUImageContext supportsFastTextureUpload]))
    {
...
- (void)renderAtInternalSize;
{
    [XDGPUImageContext setActiveShaderProgram:dataProgram];

    outputFramebuffer = [[XDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:imageSize onlyTexture:NO];
